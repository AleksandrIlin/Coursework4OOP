class Vacancy:
    ...
    def __init__(self, name: str, salary: dict, url: str, employer: str, requirement: str, responsibility: str):
    ...
    def __repr__(self):
        ...
        return (f"Vacancy({self.name}, {self.salary_from}, {self.salary_to}, {self.url}, {self.employer}, "
