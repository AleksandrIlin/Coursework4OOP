...
def test_vacancy_init():
    vacancy = Vacancy("Software Engineer", {"from": 50000, "to": 70000, "currency": "RUR"},
                      "http://example.com",
                      "Example Inc", "Python skills", "Writing code")
...
def test_vacancy_comparison():
    vacancy1 = Vacancy("Software Developer", {"from": 50000, "to": 70000, "currency": "RUR"},
                       "http://example.com", "Example Inc.",
                       "Python, SQL", "Writing code")
    vacancy2 = Vacancy("Data Scientist", {"from": 60000, "to": 80000, "currency": "RUR"},
                       "http://example2.com", "Example2 Inc.",
                       "Machine Learning, Statistics", "Writing code")

    assert vacancy1.salary_to < vacancy2.salary_to
    assert vacancy2.salary_to > vacancy1.salary_to


def test_vacancy_with_missing_salary():
    vacancy = Vacancy("Software Engineer", None, "http://example.com",
                      "Example Inc", "Python skills", "Writing code")
...
def test_vacancy_repr():
    vacancy = Vacancy("Software Engineer", {"from": 50000, "to": 70000, "currency": "RUR"},
                      "http://example.com", "Example Inc", "Python skills",
                      "Writing code")
    expected_output = ("Vacancy(Software Engineer, 50000, 70000, http://example.com, Example Inc, "
                       "Python skills, Writing code)")
